...
l.out: leveldbtst.cpp syncobj.o leveldbserver.o server.o client.o
	$(CC) $(FLAGS) -o l.out leveldbtst.cpp client.o syncobj.o leveldbserver.o server.o -lpthread -ljson_linux-gcc-4.6_libmt -lleveldb
